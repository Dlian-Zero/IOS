...
surplusTitleLabel.font = Font.systemFont(12)
...
dateLabel.font = Font.systemFont(6)
...
surplusValueLabel.font = Font.boldRoundedSystemFont(15)
...
for(let i = 0; i < boxsCount; i++) {
  ...
  boxs[i].imageSize = scaleImage(boxs[i].image.size, 8);
